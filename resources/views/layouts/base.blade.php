...
<head>
    <meta charset="utf-8">
    <title>HamroSewa - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel: +977 9856069577"><i class="fa fa-phone"></i>  +977 9856069577</a></li>
                            <li><a href="mailto:contact@hamrosewapkr@gmail.com"><i class="fa fa-envelope"></i>
                            contact@hamrosewapkr@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel: +977 9856069577"><i class="fa fa-phone"></i>
                                    +977 9856069577</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> Pokhara,Kaski</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Pokhara,
                                    Kaski</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="#">Appliances</a>
                        <ul class="drop-down one-column hover-fade">
                            <li><a href="http://127.0.0.1:8000/computer-repair/services">Computer Repair</a></li>
                            <li><a href="http://127.0.0.1:8000/tv/services">TV</a></li>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Pokhara, Kaski, Gandaki, Nepal</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@hamrosewapkr@gmail.com">contact@hamrosewapkr@gmail.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+911234567890">+977 9856069577</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+911234567890">+977 9856069577</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">© 2022 HamroSewa. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
