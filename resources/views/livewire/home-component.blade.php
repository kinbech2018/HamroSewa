        ...
        <div class="content_info">
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2>HamroSewa <span>Choice</span> of Services</h2>
                    ...
                    <div class="row">
                        <div class="col-md-4 ">
                            <div class="services-lines-info">
                                <h2><b>हाम्रो सेवामा स्वागत छ</b></h2>
                                <p class="lead">
                                <h4>एकै ठाउँमा उत्कृष्ट सेवाहरू बुक गर्नुहोस्</h4>
                                    <span class="line"></span>
                                </p>

                                <p>Find a wide variety of home services in HamroSewa.</p>
                            </div>
                        </div>
                        <div class="col-md-8">
